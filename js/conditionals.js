...
//     if(str ==='red'){
//         return'this is my favorite color'
//     }else if(str === 'blue'){
//         return 'Blue is calming'
//     }else if (str === 'yellow'){
    ...
    const analyzeColor = (str) => {
        switch(str){
            ...
            case 'red':
                ...
                break;
            case 'yellow':
                return 'yellow is the colore of lemons'
                break;
            case 'orange':
                return 'Nothing really rhymes with orange'
                break;
            default:
...
function question(){
    ...
    if(confirmation == true){
        ...
        if(typeof number == 'number'){
            ...
            number > 0 ? alert('Your number is positive') : alert(' Your number is negative');
        }else{
